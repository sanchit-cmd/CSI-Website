...
const PastLeads = ({ mode, handleLeads }) => {
	return (
		<div
			name='leads'
			className={`border-2 m-4 flex flex-col justify-center items-center p-4  gap-4 ${
				mode ? 'bg-gray-300 text-black' : 'text-white bg-black'
			}`}
		>
			<h1
			...
			>
				<p className='text-lg font-semibold mb-4 text-center mt-8'>
					Executive Leads
				</p>
